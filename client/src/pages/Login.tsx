            ...
            <div className="bg-white p-8 rounded-lg shadow-luxury">
              <div className="text-center mb-8">
                ...
                <p className="font-roboto text-melita-medium">
                  Sign in to your Melita account
                </p>
              </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={handleInputChange}
                      className="h-4 w-4 text-melita-golden-taupe focus:ring-melita-golden-taupe border-melita-warm-sand rounded"
                    />
                    <Label htmlFor="rememberMe" className="font-roboto text-sm text-melita-deep-coffee">
                      Remember me
                    </Label>
                  </div>
                  <Link 
                    to="/forgot-password" 
                    className="font-roboto text-sm text-melita-golden-taupe hover:text-melita-deep-coffee transition-colors"
                  >
                    Forgot password?
                  </Link>
                </div>
