...
const Moisturizer = () => {
  const ingredientData = {
    ...
    "All Ingredients": {
      ...
      description: "List your moisturizer ingredients here...",
      benefits: []
    }
  } as const;
  ...
  const features = [
    ...
    { text: "Instant Comfort", icon: Sparkles },
    { text: "pH Balanced", icon: Scale },
    { text: "Layers Well Under Sunscreen", icon: Palette },
  ];
