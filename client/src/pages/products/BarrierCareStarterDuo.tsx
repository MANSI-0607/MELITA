...
const BarrierCareStarterDuo = () => {
  const ingredientData = {
    "Ceramides": {
      title: "Ceramides",
      description: "Strengthens barrier and reduces moisture loss.",
    ...
    "All Ingredients": {
      ...
      description: "List your duo ingredients here...",
      benefits: []
    }
  } as const;
  ...
  return (
    <>
      <ProductPage slug="barrier-care-starter-duo" />

      {/* Why You'll Love It */}
      <section className="max-w-7xl mx-auto mt-12 px-4">
        <div className="grid md:grid-cols-2 gap-6 items-start">
          <div className="relative group rounded-2xl overflow-hidden">
            <img src={whyLoveImg} alt="Barrier Care Starter Duo Visual" className="w-full h-full object-cover rounded-2xl" />
          </div>
...
export default BarrierCareStarterDuo;
